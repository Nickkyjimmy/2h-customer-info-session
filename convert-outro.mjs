...
const inputFile = path.join(process.cwd(), 'public/outro-2.mp4');
const outputDir = path.join(process.cwd(), 'public/outro-animation');
...
console.log('Starting Outro Video conversion (Attempt 2)...');
...
try {
    ...
    // -c:v libwebp -> FORCE single frame encoder, NOT libwebp_anim
    // -q:v 75 -> quality 75
